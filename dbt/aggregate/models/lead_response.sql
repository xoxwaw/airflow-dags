...
LEFT JOIN   `ingest.number_of_dependents` as cnd ON cast(clr.number_of_dependents_code as string)=cast(cnd.code as string)
LEFT JOIN   `ingest.source_of_income` as csi ON  cast(clr.source_of_income_code as string) = cast(csi.code as string)